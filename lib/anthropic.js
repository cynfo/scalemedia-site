...
function getConfig() {
  return {
    ...
    maxTokens: parseInt(process.env.MAX_TOKENS || '12000', 10),
    // Pris per million tokens (USD). Standard ~ Sonnet. Juster i .env ved behov.
    inUsdPerMtok:  parseFloat(process.env.PRICE_IN_PER_MTOK  || '3'),
    outUsdPerMtok: parseFloat(process.env.PRICE_OUT_PER_MTOK || '15'),
    timeoutMs: parseInt(process.env.GENERER_TIMEOUT_MS || '180000', 10)
  };
}
