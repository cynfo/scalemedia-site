...
- KRITISK – SIDEN MÅ BLI KOMPLETT: hele dokumentet skal alltid avsluttes med </html>. Vær økonomisk og effektiv med CSS og markup – gjenbruk klasser, unngå oppblåst, repeterende eller overflødig kode. Sikt på en stram, komplett og polert side (omtrent 4–6 seksjoner) fremfor en svært lang en. En kort, ferdig side er alltid bedre enn en lang, avkuttet side.
...
- En fokusert side med 4–6 seksjoner som passer sidetypen: hero med tydelig verditilbud + CTA, deretter de viktigste seksjonene (velg blant tjenester/produkter, hvorfor velge oss, kort om oss, ev. én av priser/FAQ/anmeldelser), og en footer med kontaktinfo. Ta med det som gir mest effekt – ikke alt.
